...
async def list_drugs(
    q: Optional[str] = Query(None, description="关键词搜索（通用名/商品名）"),
    category: Optional[str] = Query(None, description="按药品分类过滤"),
    ...
    items, total = await service.get_list(params, category=category, q=q)
